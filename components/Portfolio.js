		...
		<div className="container">
            ...
            <div className="row">
                ...
                <div className="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div className="grid wow zoomIn">
                        <a href="https://control-sb.ru/" target="blank">
	                        <figure className="effect-bubba">
	                            <img src="assets/images/work/control-sb.ru.png" alt="control-sb.ru"/>
	                            <figcaption>
	                                <h2>Системы <span>контроля</span></h2>
	                                <p>Доработки</p>
	                            </figcaption>
	                        </figure>
                        </a>
                ...
                <div className="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div className="grid wow zoomIn">
                        <a href="https://akva-market.online/" target="blank">
	                        <figure className="effect-bubba">
	                            <img src="assets/images/work/akva-market.online.png" alt="akva-market.online"/>
	                            <figcaption>
	                                <h2>Акваклининг <span>Центр</span></h2>
	                                <p>Интеграция, доработки, ремонт</p>
	                            </figcaption>
	                        </figure>
                        </a>
                ...
                <div className="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div className="grid wow zoomIn">
                        <a href="http://www.souzplastic.ru/" target="blank">
	                        <figure className="effect-bubba">
	                            <img src="assets/images/work/souzplastic.ru.png" alt="souzplastic.ru"/>
	                            <figcaption>
	                                <h2>СОЮЗПЛАСТИК</h2>
	                                <p>Доработки</p>
	                            </figcaption>
